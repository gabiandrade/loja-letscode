package br.com.letscode.lojaletscode.config;

import br.com.letscode.lojaletscode.config.security.JWTAuthenticationFilter;
...
public class ECommerceAppSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public static void main(String[] args) {
        System.out.println(new BCryptPasswordEncoder().encode("gabriela123"));
    }
